...
void onADCReady(uint16_t value) {
  ...
  ADC_result =
      value; // Store latest ADC value for main loop or other interrupts
}
...
// Fires every 500ms  →  OCR2 = (8MHz / 1024 / 2) - 1 = 3905  — too big for
// 8-bit! Use prescaler 1024, fire every ~31ms, count 16 ticks = ~500ms
